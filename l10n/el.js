OC.L10N.register(
    ...
    "Share" : "Διαμοιρασμός",
    "Share with people on other ownClouds using the syntax username@example.com/owncloud" : "Διαμοιρασμός με άτομα σε άλλα διακομιστές ownCloud χρησιμοποιώντας την σύνταξη username@example.com/owncloud",
    ...
    "For more information, please contact your friendly ownCloud administrator." : "Για περισσότερες πληροφορίες παρακαλούμε, επικοινωνήστε με το φιλικό διαχειριστή του ownCloud σας.",
